...
# ReadMe: [review ticket](https://github.com/ranand2445/curly-knife)
## Github Activities:
Key things I learned: I learned how to impliment menu's and how to you can call functions in menu options, so that certain things can be run when you select that 
